  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-[#030603]/85 backdrop-blur-md border-b border-emerald-500/20 py-3 shadow-lg shadow-black/40"
          : "bg-transparent py-5"
      }`}
    >
      <div className="container-app flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/dashboard"
            className="bg-white text-black hover:bg-emerald-300 font-semibold px-4 py-2 rounded-md text-sm transition-all shadow-md shadow-white/10 hover:shadow-emerald-500/20 active:scale-95"
          >
            Book a Demo
          </Link>
        </div>
