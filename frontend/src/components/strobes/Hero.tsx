    ...
    <section className="relative min-h-screen pt-32 pb-20 overflow-hidden strobes-grid-bg flex flex-col justify-center items-center">
      ...
      <div className="container-app relative z-10 text-center max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mb-12">
          <Link
            href="/dashboard"
            className="w-full sm:w-auto bg-white text-black hover:bg-emerald-300 font-semibold px-7 py-3.5 rounded-md text-base transition-all flex items-center justify-center gap-2 shadow-lg shadow-white/10 hover:shadow-emerald-500/25 active:scale-95 group"
          >
